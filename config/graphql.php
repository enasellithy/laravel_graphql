...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'getUser' => \App\GraphQL\Queries\GetUserQuery::class,
                'authenticatedUser' => \App\GraphQL\Queries\AuthenticatedUserQuery::class,
            ],
            'mutation' => [
                'loginEmail' => \App\GraphQL\Mutations\LoginEmailMutation::class,
                'loginUsername' => \App\GraphQL\Mutations\LoginUsernameMutation::class,
                'loginPhone' => \App\GraphQL\Mutations\LoginPhoneMutation::class,
            ...
            'types' => [
                ...
                'LoginResult' => \App\GraphQL\Types\LoginResult::class,
            ],
